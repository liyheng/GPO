...
class StatelessHalfcheetah(Halfcheetah):
  def __init__(self):
    super().__init__(noise_sigma=0.0)
class NoisyStatelessHalfcheetahEasy(Halfcheetah):
  def __init__(self):
    super().__init__(noise_sigma=0.1)
class NoisyStatelessHalfcheetahMedium(Halfcheetah):
  def __init__(self):
    super().__init__(noise_sigma=0.2)
class NoisyStatelessHalfcheetahHard(Halfcheetah):
  def __init__(self):
