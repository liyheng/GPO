...
class StatelessHumanoid(Humanoid):
  def __init__(self):
    super().__init__(noise_sigma=0.0)
class NoisyStatelessHumanoidEasy(Humanoid):
  def __init__(self):
    super().__init__(noise_sigma=0.1)
class NoisyStatelessHumanoidMedium(Humanoid):
  def __init__(self):
    super().__init__(noise_sigma=0.2)
class NoisyStatelessHumanoidHard(Humanoid):
  def __init__(self):
